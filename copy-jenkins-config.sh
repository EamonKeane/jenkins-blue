...
# Create jenkins secret for storing credentials
kubectl create secret generic jenkins-credentials --namespace jenkins --from-file=jenkins-secrets/credentials.xml